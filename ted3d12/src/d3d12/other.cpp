...
bool_t D3D12CommandBuffer::Draw(ref_t<IGfxVertexBuffer> buffer, int_t offset, int_t size)
{
...
bool_t D3D12Device::CreateGfxCommandBuffer(out_ptr_t<IGfxCommandBuffer> buffer, GfxCommandBufferDesc& desc)
{
        // Create an empty root signature.
    {
        CD3DX12_ROOT_SIGNATURE_DESC rootSignatureDesc;
