...
bool GLRenderingDevice::InitializeExtensions(ptr_t m_pInstance)
{
	WNDCLASSEX wc;
...
bool GLRenderingDevice::InitializeOpenGL(HWND hwnd, int screenWidth, int screenHeight, float screenDepth, float screenNear, bool vsync)
{
...
bool GLRenderingDevice::LoadExtensionList()
{
